...
- **Mouse wheel scrolling**: SGR mouse mode (`\x1b[?1006h\x1b[?1000h`) is enabled on client startup. Mouse wheel up enters copy mode and scrolls up through scrollback. Wheel down scrolls down; reaching the bottom exits copy mode automatically. Other mouse events are ignored.
